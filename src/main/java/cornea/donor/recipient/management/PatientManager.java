...
public class PatientManager {
    public void yeniHastaEkle(Patient hasta) {
    ...
    public List<Patient> tumHastalariListele() {
    ...
    public Patient hastaGetirById(int id) {
    ...
    private List<String> degisenAlanlariBul(Patient eski, Patient yeni) {
    ...
    public String hastaDuzenle(Patient hasta) {
        Patient eskiHasta = hastaGetirById(hasta.getId());
